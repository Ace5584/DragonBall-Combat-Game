...
standRight = [pygame.image.load('goku/standR_1.png'), pygame.image.load('goku/standR_2.png')]
standLeft = [pygame.image.load('goku/standL_1.png'), pygame.image.load('goku/standL_2.png')]
vanish = pygame.image.load('goku/vanish.png')

c2_walkRight = [pygame.image.load('goku/R.png')]
c2_walkLeft = [pygame.image.load('goku/L.png')]
c2_standRight = [pygame.image.load('goku/standR_1.png'), pygame.image.load('goku/standR_2.png')]
c2_standLeft = [pygame.image.load('goku/standL_1.png'), pygame.image.load('goku/standL_2.png')]
c2_vanish = pygame.image.load('goku/vanish.png')
...
c2_punch_left = [pygame.image.load('goku/L_punch_1.png'), pygame.image.load('goku/L_punch_2.png'),
                 pygame.image.load('goku/L_punch_2.png'), pygame.image.load('goku/L_punch_4.png'),
                 pygame.image.load('goku/L_kick_1.png'), pygame.image.load('goku/L_kick_2.png'),
                 pygame.image.load('goku/L_kick_3.png'), pygame.image.load('goku/L_kick_4.png')]
c2_punch_right = [pygame.image.load('goku/R_punch_1.png'), pygame.image.load('goku/R_punch_2.png'),
                  pygame.image.load('goku/R_punch_2.png'), pygame.image.load('goku/R_punch_4.png'),
                  pygame.image.load('goku/R_kick_1.png'), pygame.image.load('goku/R_kick_2.png'),
                  pygame.image.load('goku/R_kick_3.png'), pygame.image.load('goku/R_kick_4.png')]
...
c2_left_move_teleport = [pygame.image.load('goku/L_move_forward.png'), pygame.image.load('goku/L_move_forward2.png')]
c2_right_move_teleport = [pygame.image.load('goku/R_move_forward.png'), pygame.image.load('goku/R_move_forward2.png')]
...
c2_shoot_left = [pygame.image.load('goku/L_attack_1.png'), pygame.image.load('goku/L_attack_2.png'),
                 pygame.image.load('goku/L_attack_3.png')]
c2_shoot_right = [pygame.image.load('goku/R_attack_1.png'), pygame.image.load('goku/R_attack_2.png'),
                  pygame.image.load('goku/R_attack_3.png')]
...
class Player():
    def __init__(self, x, y, width, height, left, text_location, player_name, character, screen_x, screen_y):
        ...
        self.bullet_count = 100  # Counting the remaining bullets for the character
    ...
    def draw(self, win, character):
        if character == 1:
            if not self.shoot_status:
                if self.teleport and self.teleport_remain > 0:
                    if self.right:
                        win.blit(right_move_teleport[0], (int(self.x), int(self.y)))
                        win.blit(right_move_teleport[1], (int(self.x), int(self.y)))
                        win.blit(vanish, (int(self.x), int(self.y)))
                        self.x = 1280 - 128
                    else:
                        win.blit(left_move_teleport[0], (int(self.x), int(self.y)))
                        win.blit(left_move_teleport[1], (int(self.x), int(self.y)))
                        win.blit(vanish, (int(self.x), int(self.y)))
                        self.x = 0
                    ...
                    if not self.knock_down:
                        if self.walking:
                            if self.walk_count + 1 >= len(walkLeft):
                                ...
                                self.walk_count += 1
                        elif not self.walking and not self.stabbing:
                            if self.left:
        ...
        if character == 2:
            if not self.shoot_status:
                if self.teleport and self.teleport_remain > 0:
                    print(self.teleport_remain)
                    if self.right:
                        win.blit(c2_right_move_teleport[0], (int(self.x), int(self.y)))
                        win.blit(c2_right_move_teleport[1], (int(self.x), int(self.y)))
                        win.blit(c2_vanish, (int(self.x), int(self.y)))
                        self.x = 1280 - 128
                    else:
                        win.blit(c2_left_move_teleport[0], (int(self.x), int(self.y)))
                        win.blit(c2_left_move_teleport[1], (int(self.x), int(self.y)))
                        win.blit(c2_vanish, (int(self.x), int(self.y)))
                        self.x = 0
                    self.teleport_remain -= 1
                if not self.vanish:
                    if not self.knock_down:
                        ...
                        print(self.knock_down_count)
                        if self.knock_down_direction > 0:
                    ...
                    if self.stab_count >= 0:
                        ...
                        if self.x - 10 > self.vol:
                            if round(self.stab_count) == 1 or round(self.stab_count) == 4:
                                self.x -= 20
                                enemy.knock_down = True
                                enemy.knock_down_direction = self.walk
                        elif self.x - 3 > self.vol:
                            self.x -= 3
                    if self.stab_count >= 6:
                        self.stab_count = 0
